...
export const SpinnerNative = () => {
  ...
  useEffect(() => {
    // Animated.loop does not work with nativeDriver (a bug in RN)
    // that is why we do a hack: we start only one full rotation
    // and once it's finished, we start it again
